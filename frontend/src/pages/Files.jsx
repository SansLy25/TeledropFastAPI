            ...
            <Main>
                <div className="w-full flex flex-col">
                    ...
                    <ListFileView
                        ...
                        folders={[{name: "Море"}, {name: "Моя любимая папка"}, {name: "Папка с большим названием c еще большим названием"},{name: "Море"}, {name: "Моя любимая папка"}, {name: "Папка с большим названием c еще большим названием"},]}
                        view="big"
                    />
                </div>
            </Main>
